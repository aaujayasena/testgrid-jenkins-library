...
def sendEmail(deploymentDirectories, updateType) {
    ...
    content="""
        ...
        """
    subject="[TestGrid][${updateType.toUpperCase()}][${product.toUpperCase()}:${product_version}][E2E]-Build ${currentBuild.currentResult}-#${env.BUILD_NUMBER}"
